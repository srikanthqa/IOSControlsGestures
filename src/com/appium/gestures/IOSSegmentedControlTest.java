...
public class IOSSegmentedControlTest {
	public static void main(String[] args) throws Exception{
		...
		System.out.println(driver.findElements(By.className("UIASegmentedControl")).size());
		driver.findElements(By.className("UIASegmentedControl")).get(3).findElement(By.name("Check")).click();
		Thread.sleep(5000);
		driver.quit();
	}
